...
export { default as FailIcon } from './Icons/FailIcon'
...
export { default as AXS } from './Icons/Axs'
export { default as SLP } from './Icons/Slp'
...
export { default as RoninIcon } from './Icons/Ronin'
